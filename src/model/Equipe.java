...
public class Equipe implements Serializable {
    ...
    public Equipe(String nom, String histoireDuClub, int budgetTransferts, int masseSalariale, int budgetTeamBuilding, List<Joueur> joueurs, Entraineur entraineur, President president, Stade stade, Ligue ligue) {
        this.nom = nom;
    ...
    public void setBudgetTransferts(int newBudget) {
        if(newBudget < 0) {
    ...
    public void setMasseSalariale(int newBudget) {
        if(newBudget < 0) {
            this.masseSalariale = Integer.MAX_VALUE;
        }else if(newBudget <= 0) {
            this.masseSalariale = 0;
        }else {
            this.masseSalariale = newBudget;
        }
    }
